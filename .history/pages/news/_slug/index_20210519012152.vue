        ...
        <div class="article-content">
          <dl class="article-content__header">
            <dd class="article-content__header__date">
              <span v-text="$dayjs(article.published).locale('ja').format('YYYY/MM/DD')" />
              </dd>
            <dd>
              <span v-if="article.category == 'event'" class="article-content__category event fontUppercase">event</span>
              <span v-if="article.category == 'news'" class="article-content__category news fontUppercase">news</span>
              <span v-if="article.category == 'media'" class="article-content__category media fontUppercase">media</span>
            </dd>
            <dt><h2 class="article-content__header__title">{{ article.title }}</h2></dt>
          </dl>
    ...
    <div class="l-breadcrumb">
      <div class="l-breadcrumb__inner">
        <ul class="l-breadcrumb__inner__items">
          ...
          <li class="l-breadcrumb__inner__items__item">
            <span class="l-breadcrumb__inner__items__item__text--nolink fontUppercase">{{ article.title }}</span>
          </li>
        </ul>
      </div>
    </div>
